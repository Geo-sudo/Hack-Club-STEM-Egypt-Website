...
submit.addEventListener("click", () => {
    ...
    if (value == "3THz_IR" || value == "Salute_Salute" || value == "Behind_The_Words" || value == "HACK_KIMO_KIMO" || value == "Always_Hack" || value == "password_is_password" || value == "deadly_weapon" || value == "The_End" || value == "RUN" || value == "Triumph") {
